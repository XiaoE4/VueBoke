    ...
    <el-table
        ...
        <el-table-column
            ...
            <template slot-scope="scope">
                <el-tag
                    :type="scope.row.jinyan === '否' ? 'success' : 'danger'  "
                    disable-transitions>{{scope.row.jinyan}}</el-tag>
            </template>
        </el-table-column>
        <el-table-column label="操作">
            <template slot-scope="scope">
                ...
                <el-button
                    size="mini"
                    type="danger"
                    @click="handleJin(scope.$index, scope.row)">禁言</el-button>
                <el-button
                    size="mini"
                    type="danger"
                    @click="handleUnjin(scope.$index, scope.row)">解除</el-button>
            </template>
        </el-table-column>
    </el-table>
            ...
            this.$axios({
                ...
                this.$axios({
                    ...
                    for(let i=0;i<this.tableData.length;i++){
                        ...
                        if(this.tableData[i].jinyan===1){
                            this.tableData[i].jinyan="是"
                        }else{
                            this.tableData[i].jinyan="否"
                        }
                    }
