    ...
    <el-table
        ...
        <el-table-column
            ...
            <template  slot-scope="scope">
                <el-tag type="info" v-if="scope.row.Cpic && scope.row.content">普通文章</el-tag>
        ...
        <el-table-column
            ...
            <template slot-scope="scope" v-if="scope.row.Cpic">
                <p>
                    <img :src="require('../assets/pic-content/'+ scope.row.Cpic +'.jpg')" alt="" id="root_pic">
                </p>
            </template>
        </el-table-column>
        <el-table-column
        ...
        getAllArticle(){
            ...
            this.$axios({
                ...
                for(let i =0;i<res.data.length;i++){
                    ...
                    if(!res.data[i].video && res.data[i].content){
