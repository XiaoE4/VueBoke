        ...
        <el-table
            ...
            <el-table-column
                ...
                <template  slot-scope="scope">
                    <el-tag type="success" v-if="!scope.row.title && scope.row.Cpic">图片</el-tag>
                </template>
            </el-table-column>
            <el-table-column
                label="标题"
        ...
        getAllPic(){
            ...
            this.$axios({
                ...
                for(let i =0;i<res.data.length;i++){
                    ...
                    if(!res.data[i].content && res.data[i].Cpic){
                        res.data[i].Cpic = res.data[i].Cpic.split(',')
                        self.tableData.push(res.data[i])
                        console.log(self.tableData[2])
                    }
                }
